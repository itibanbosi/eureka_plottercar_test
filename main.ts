input.onButtonPressed(Button.A, function () {
    ...
    eureka_plotter_car.plottercar_forward(2.3)
    for (let index = 0; index < 5; index++) {
    ...
    for (let index = 0; index < 3; index++) {
        eureka_plotter_car.plottercar_pen(pen_onoff.下げる)
        eureka_plotter_car.plottercar_forward(4.6)
        eureka_plotter_car.plottercar_pen(pen_onoff.上げる)
...
eureka_plotter_car.plotter_degree(7)
